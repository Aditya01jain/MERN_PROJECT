        ...
        <AppBar position="static" sx={{ bgcolor: palette.primary.main }}>
            <Container >
                ...
                <Toolbar disableGutters>
                    ...
                    >
                        <img src="https://i.ibb.co/pd38RJr/JOB.png" alt="JOB" border="0" height={50}></img>
                    </Typography>
                    ...
                    >
                        <img src="https://i.ibb.co/pd38RJr/JOB.png" alt="JOB" border="0"></img>
                    </Typography>
                    ...
                    <Box sx={{ flexGrow: 0 }}>
                        ...
                        :(<><Tooltip title="Open settings">
                                <IconButton onClick={handleOpenUserMenu} sx={{ p: 0, zIndex: 10 }}>
                                    <Avatar sx={{ color: palette.primary.white }} alt="Remy Sharp" src="https://www.vhv.rs/dpng/d/421-4212514_user-icon-round-png-png-download-user-round.png" />
                                </IconButton>
                            </Tooltip></>
                        )
                        }
